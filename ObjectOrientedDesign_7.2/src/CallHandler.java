...
public class CallHandler {
	...
	/* Routes the call to an available employee, or saves ina queue if no employee available*/
	...
	/*Routes the call to an available employee, or saves ina queue if no empployee available */
	...
	/* An employee got free. Look for a waiting call that he/she can server. Return true
	 * if we were able to assing a call, false otherwise
	 */
